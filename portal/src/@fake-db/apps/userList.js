...
// POST: Add new user
mock.onPost('/apps/candidates/add-candidate').reply(config => {
...
// GET: Updated DATA
mock.onGet('/apps/candidates/list').reply(config => {
...
mock.onGet('/apps/candidate').reply(config => {
...
// DELETE: Deletes User
mock.onDelete('/apps/candidates/delete').reply(config => {
